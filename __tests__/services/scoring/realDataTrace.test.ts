...
const REAL_INGREDIENTS: ProductIngredient[] = [
  makeIngredient({ position: 1,  canonical_name: 'salmon',           dog_base_severity: 'good',    cat_base_severity: 'good',    cluster_id: 'protein_salmon', allergen_group: 'fish', is_protein_fat_source: true }),
  makeIngredient({ position: 2,  canonical_name: 'salmon_meal',      dog_base_severity: 'good',    cat_base_severity: 'good',    cluster_id: 'protein_salmon', allergen_group: 'fish', is_protein_fat_source: true }),
  ...
  makeIngredient({ position: 6,  canonical_name: 'poultry_fat',      dog_base_severity: 'caution', cat_base_severity: 'caution', is_protein_fat_source: true }),
  ...
  makeIngredient({ position: 8,  canonical_name: 'fish_meal',        dog_base_severity: 'caution', cat_base_severity: 'caution', allergen_group: 'fish', is_unnamed_species: true, is_protein_fat_source: true }),
  ...
  makeIngredient({ position: 11, canonical_name: 'natural_flavor',   dog_base_severity: 'caution', cat_base_severity: 'caution', is_unnamed_species: true, position_reduction_eligible: false, is_protein_fat_source: true }),
...
describe('Real Data Trace: Pure Balance Wild & Free Salmon & Pea (Dog)', () => {
  test('full pipeline trace → 62 (D-137: DCM fires, mitigation applies)', () => {
    ...
    expect(base).toBeCloseTo(59.9, 1);
