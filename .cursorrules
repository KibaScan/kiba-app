...
- **Pure Balance Grain-Free Salmon (Dog)** = 62
- **Temptations Classic Tuna (Cat Treat)** = 9
...
9. **Suitability framing (D-094)** — always `"[X]% match for [Pet Name]"`, never naked scores
...
- After scoring changes: verify Pure Balance = 62, Temptations = 9
...
4. Verify regression anchors: Pure Balance = 62, Temptations = 9
