...
- **Pure Balance Grain-Free Salmon (Dog)** = 60
...
- After scoring changes: verify Pure Balance = 60, Temptations = 0
...
4. Verify regression anchors: Pure Balance = 60, Temptations = 0
