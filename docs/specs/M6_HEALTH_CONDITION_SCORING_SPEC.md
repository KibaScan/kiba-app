...
**Pure Balance = 62 must hold** for a pet with no health conditions. Condition adjustments are Layer 3 only — they don't fire when `health_conditions` is empty. Zero regression risk for the baseline.
